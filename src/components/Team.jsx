                ...
                <div className="flex flex-wrap gap-6 mt-9 max-md:px-3">
                    {TEAM_DATA.map((item, index) => (
                        <div className='flex mx-auto flex-col w-full max-md:max-w-[320px] max-w-[202px] mb-3' id={index}>
                            ...
                            <h3 className='font-Franklin font-normal text-2xl leading-[27px] text-center pt-2 sm:pt-[23px] text-[#3586FF]'>{item.job}</h3>
                            ...
                            <a className='flex justify-center mx-auto mt-2 max-w-max' href="">{<item.icon />}</a>
                        </div>
                    ))}
                </div>
            </div>
