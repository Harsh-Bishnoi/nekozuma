                ...
                <div className="flex flex-wrap gap-6 mt-9 max-md:px-3">
                    {TEAM_DATA.map((item, index) => (
                        <div className='flex mx-auto flex-col w-full max-md:max-w-[320px] max-w-[202px] mb-3' id={index}>
                            ...
                            <a className='flex justify-center mx-auto mt-4 max-w-max hover:scale-110 transition-all duration-200 ease-linear team-svg-size' href="https://x.com/" target='_blank'>{<item.icon />}</a>
                        </div>
                    ))}
                </div>
            </div>
